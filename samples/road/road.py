...
class DrugDataset(utils.Dataset):
        ...
        for index in range(num_obj):
            for i in range(info['width']):
                for j in range(info['height']):
                    ...
                    if at_pixel == 17:
                        mask[j, i, index] = 1
                    elif at_pixel == 33 or i == 161:
                        mask[j, i, index] = 1
                    elif at_pixel == 34 or i == 162:
                        mask[j, i, index] = 1
                    elif at_pixel == 35 or i == 163:
                        mask[j, i, index] = 1
                    elif at_pixel == 36 or i == 164:
                        mask[j, i, index] = 1
                    elif at_pixel == 37 or i == 165:
                        mask[j, i, index] = 1
                    elif at_pixel == 38 or i == 166:
                        mask[j, i, index] = 1
                    elif at_pixel == 39 or i == 167:
                        mask[j, i, index] = 1
                    elif at_pixel == 40 or i == 168:
                        mask[j, i, index] = 1
                    elif at_pixel == 49:
                        mask[j, i, index] = 1
                    elif at_pixel == 50:
    ...
    def load_mask(self, image_id):
        ...
        labels_form,num_obj = self.from_json_get_labels_form(image_id)
